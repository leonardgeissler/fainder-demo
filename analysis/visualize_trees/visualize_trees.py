...
def visualize_trees():
    ...
    for query_name, query in queries.items():
        ...
        tree.pydot__tree_to_png(delete_leaf_nodes.transform(parsered_tree), f"{folder}/parse_tree_{query_name}.png", rankdir="TB")
        ...
        tree.pydot__tree_to_png(delete_leaf_nodes.transform(optimized_tree), f"{folder}/optimized_parse_tree_{query_name}.png", rankdir="TB")

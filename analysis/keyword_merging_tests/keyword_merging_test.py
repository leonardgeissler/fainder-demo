...
def run_comparison(
    ...
    return merged_results, unmerged_results, merged_time, unmerged_time, is_consistent, term_count
...
@pytest.mark.parametrize(
    ("test_name", "merged_query", "unmerged_query"),
    generate_keyword_test_cases()
)
def test_keyword_merging(
    ...
    assert set(merged_results) == set(unmerged_results), "Results are inconsistent between merged and unmerged queries"

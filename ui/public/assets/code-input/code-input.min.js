var codeInput = {
  ...
  registerTemplate: function (a, b) {
    ...
    if (
      ...
      console.log(
        `code-input: template: Added existing elements with template ${a}`,
      );
    }
  ...
  CodeInput: class extends HTMLElement {
    ...
    update() {
      ...
      (b += "\n"),
        ...
        this.template.includeCodeInputInHighlightFunc
          ? this.template.highlight(a, this)
          : this.template.highlight(a),
        this.syncSize(),
        this.textareaElement === document.activeElement &&
          ((this.handleEventsFromTextarea = !1),
          this.textareaElement.blur(),
          this.textareaElement.focus(),
          (this.handleEventsFromTextarea = !0)),
        this.pluginEvt("afterHighlight");
    }
    syncSize() {
      this.template.preElementStyled
        ? ((this.style.backgroundColor = getComputedStyle(
            this.preElement,
          ).backgroundColor),
          (this.textareaElement.style.height = getComputedStyle(
            this.preElement,
          ).height),
          (this.textareaElement.style.width = getComputedStyle(
            this.preElement,
          ).width))
        : ((this.style.backgroundColor = getComputedStyle(
            this.codeElement,
    ...
    setup() {
      ...
      let a = this.getAttribute("language") || this.getAttribute("lang"),
        b =
          ...
          "",
        c =
          this.unescapeHtml(this.innerHTML) || this.getAttribute("value") || "";
      this.initialValue = c;
      ...
      for (let a, b = 0; b < this.attributes.length; b++)
        (a = this.attributes[b].name),
          (codeInput.textareaSyncAttributes.includes(a) ||
            ...
            d.setAttribute(a, this.getAttribute(a));
      ...
      f.setAttribute("aria-hidden", "true"),
        ...
        f.append(e),
        this.append(f),
        this.template.isCode &&
          a != null &&
          "" != a &&
          e.classList.add("language-" + a.toLowerCase());
      let g = document.createElement("div");
      g.classList.add("code-input_dialog-container"),
        this.append(g),
        (this.dialogContainerElement = g);
      let h = document.createElement("div");
      h.classList.add("code-input_keyboard-navigation-instructions"),
        g.append(h),
      ...
      for (const b of a)
        if ("attributes" === b.type) {
          for (let a = 0; a < codeInput.observedAttributes.length; a++)
            if (b.attributeName == codeInput.observedAttributes[a])
              return this.attributeChangedCallback(
                b.attributeName,
                b.oldValue,
                super.getAttribute(b.attributeName),
              );
          if ("aria-" == b.attributeName.substring(0, 5))
            return this.attributeChangedCallback(
              b.attributeName,
              b.oldValue,
              super.getAttribute(b.attributeName),
